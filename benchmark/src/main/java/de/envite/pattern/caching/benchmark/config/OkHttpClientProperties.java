...
public class OkHttpClientProperties {
    ...
    public static class Cache {
        ...
        /**
         * Base directory which is used to create cache directories per cache instance.
         */
        private File baseDirectory = new File(System.getProperty("java.io.tmpdir"), "http_cache-" + UUID.randomUUID());

        /**
         * The maximum size of a cache instance in bytes.
         */
